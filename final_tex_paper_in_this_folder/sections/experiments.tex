...
To clarify scope, I do not assess recommendation quality on held-out datasets and I do not report relevance metrics (e.g., MAP@k). 
Instead, I empirically examine geometric properties of the training dynamics across encoder architectures and training designs, focusing on the orthogonality of embedding updates and the frequency–norm coupling predicted by the theory.
