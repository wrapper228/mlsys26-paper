...
Consider a single generation slot. I use a shared uniform random variable $U \sim \mathrm{Uniform}(0,1)$ and a categorical draw over non-$i$ items $Z \sim \mathrm{Cat}(\boldsymbol r)$:
\begin{equation}
X^{(p)} \,=\, \begin{cases}
 i, & U \le p, \\
 Z, & U > p.
