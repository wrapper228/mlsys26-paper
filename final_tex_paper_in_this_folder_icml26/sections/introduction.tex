...
\begin{itemize}
    \item \textbf{Explanation of sufficient conditions for orthogonality of embedding updates.} I prove that 
    ...
    \item \textbf{Explanation of why orthogonality of embedding updates implies popularity bias.} I prove that 
    orthogonal movement makes more popular item have systematically bigger embedding norm. Crucially, 
    I demonstrate that this geometric artifact translates directly into popularity biased retrieval 
    outcomes.
    \item \textbf{Clarification of prior claims in the literature.} I re-examine claims from studies on similar 
    ...
    \item \textbf{The ``Baseline Paradox'' in architectural design.} I identify a structural paradox where 
...
\paragraph{Scope and implications.} I establish sufficient conditions under which embedding updates are orthogonal and popularity bias emerges. Outside this regime, these effects may or may not occur; I make no claim of necessity. Other sources of popularity bias are examined in prior work \cite{zhang2023dimensional}.