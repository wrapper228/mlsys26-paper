...
Finally, we analyze the dependence of the embedding-norm growth on item popularity. Appendix~\ref{app:popularity-dependence} formalizes a clean coupling \emph{mechanism} that isolates the effect of sampling probability and proves that, in a replay model, the expected \emph{squared} norm after $T$ batches is nondecreasing in the item's sampling probability.
