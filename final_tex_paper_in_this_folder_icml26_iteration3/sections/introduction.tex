...
\begin{itemize}
    ...
    (A3) the item encoder is lookup-equivalent
    \footnote{\emph{Lookup-equivalent} encoder will be defined later in Section~\ref{sec:lookup-equivalent}.}
    ; and (A4) the loss depends on the item only via cosine. 
