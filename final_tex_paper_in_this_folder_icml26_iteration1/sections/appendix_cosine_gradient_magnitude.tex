...
\textbf{The bigger \boldmath$q$\unboldmath{}, the smaller the norm of the gradient of a cosine-based loss with respect to \boldmath$q$\unboldmath{}.}
...
\medskip
\noindent\textbf{Derivation.} We begin with the formula from Appendix~\ref{app:cos-orth-lemma}:
\begin{equation}
...
\begin{equation}
\begin{aligned}
\bigl\|P u\bigr\|^{2} &\,=\, u^{\!\top} P u \\
&\,=\, u^{\!\top}(I - \hat q\,\hat q^{\!\top})u \,=\, \|u\|^{2} - (\hat q^{\!\top}u)^{2}.
\end{aligned}
\end{equation}
Hence,
\begin{equation}
...
Here we note that, as the embedding norm grows, the gradient norm decreases:
\begin{itemize}
