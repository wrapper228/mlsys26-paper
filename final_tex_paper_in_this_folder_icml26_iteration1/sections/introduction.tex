...
\begin{itemize}
    ...
    \item \textbf{Explanation of why orthogonality of embedding updates implies popularity bias.} We prove that 
    orthogonal movement yields a frequency--norm coupling: under a clean coupling model, more popular items have larger expected squared embedding norms. Crucially, 
